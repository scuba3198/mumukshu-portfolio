		...
		<div className="max-w-4xl mx-auto">
			...
			<div className="flex flex-col">
				{projects.map((project) => (
					<div
						key={project.id}
						className="list-item-container flex flex-col md:flex-row justify-between items-start md:items-center gap-4 group"
					>
						<div className="flex-1 w-full">
							...
							<div className="flex flex-wrap gap-2 md:gap-3">
								{project.tags.map((tag) => (
									<span
										key={tag}
										className="mono text-[9px] md:text-[10px] uppercase tracking-wider text-stone-500"
									>
										# {tag}
									</span>
								))}
