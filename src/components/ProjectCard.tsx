				...
				<div>
					<div className="flex justify-between items-start mb-4">
						{project.isFeatured ? (
							...
							<span
								className={`${project.categoryBg ?? "bg-purple-500"} text-white text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded`}
							>
					...
					<h2
						className={`text-2xl font-bold mb-2 ${theme.accent ? `group-hover:${theme.accent}` : ""} transition-colors`}
					>
						{project.title}
					</h2>
